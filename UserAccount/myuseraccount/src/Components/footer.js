...
export class Footer extends Component{
  ...
  return (
    <MDBFooter color="unique-color-dark" className="page-footer font-small pt-0">
        ...
        <MDBRow className="mt-3">
          <MDBCol md="3" lg="4" xl="3" className="mb-4">
            ...
            <p>
              ...
              content. And add address of the organisation if you want.
              elit.
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> Bangalore, 560093, India
            </p>
            <p>
      ...
      <div className="footer-copyright text-center py-3" style={{ backgroundColor: "#6351ce" }}>
        <MDBContainer fluid>
